...
# installed.
TK_PREFIX='/Volumes/Project/Ai project/Comorin Consulting/Resume Screening/envs'

# Top-level directory in which Tk's platform-specific files (e.g.
# executables) are installed.
TK_EXEC_PREFIX='/Volumes/Project/Ai project/Comorin Consulting/Resume Screening/envs'
...
# build directory.
TK_BUILD_LIB_SPEC='-L/Volumes/Project/Ai project/Comorin Consulting/Resume Screening/envs/lib -ltk8.6'

# String to pass to linker to pick up the Tk library from its
# installed directory.
TK_LIB_SPEC='-L/Volumes/Project/Ai project/Comorin Consulting/Resume Screening/envs/lib -ltk8.6'

# String to pass to the compiler so that an extension can
# find installed Tk headers.
TK_INCLUDE_SPEC='-I/Volumes/Project/Ai project/Comorin Consulting/Resume Screening/envs/include'
...
# compiled.
TK_SRC_DIR='/Volumes/Project/Ai project/Comorin Consulting/Resume Screening/envs/include'
...
# build directory.
TK_BUILD_STUB_LIB_SPEC='-L/Volumes/Project/Ai project/Comorin Consulting/Resume Screening/envs/lib -ltkstub8.6'

# String to pass to linker to pick up the Tk stub library from its
# installed directory.
TK_STUB_LIB_SPEC='-L/Volumes/Project/Ai project/Comorin Consulting/Resume Screening/envs/lib -ltkstub8.6'

# Path to the Tk stub library in the build directory.
TK_BUILD_STUB_LIB_PATH='/Volumes/Project/Ai project/Comorin Consulting/Resume Screening/envs/lib/libtkstub8.6.a'

# Path to the Tk stub library in the install directory.
TK_STUB_LIB_PATH='/Volumes/Project/Ai project/Comorin Consulting/Resume Screening/envs/lib/libtkstub8.6.a'
