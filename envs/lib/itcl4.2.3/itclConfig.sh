...
# String to pass to linker to pick up the Itcl library from its
# installed directory.
itcl_LIB_SPEC='-L/Volumes/Project/Ai project/Comorin Consulting/Resume Screening/envs/lib/itcl4.2.3 -litcl4.2.3'
ITCL_LIB_SPEC='-L/Volumes/Project/Ai project/Comorin Consulting/Resume Screening/envs/lib/itcl4.2.3 -litcl4.2.3'
...
# String to pass to linker to pick up the Itcl stub library from its
# installed directory.
itcl_STUB_LIB_SPEC='-L/Volumes/Project/Ai project/Comorin Consulting/Resume Screening/envs/lib/itcl4.2.3 -litclstub4.2.3'
ITCL_STUB_LIB_SPEC='-L/Volumes/Project/Ai project/Comorin Consulting/Resume Screening/envs/lib/itcl4.2.3 -litclstub4.2.3'
...
# String to pass to linker to pick up the Itcl stub library from its
# installed directory.
itcl_STUB_LIB_PATH='/Volumes/Project/Ai project/Comorin Consulting/Resume Screening/envs/lib/itcl4.2.3/libitclstub4.2.3.a'
ITCL_STUB_LIB_PATH='/Volumes/Project/Ai project/Comorin Consulting/Resume Screening/envs/lib/itcl4.2.3/libitclstub4.2.3.a'
